...
import { toggleVariants } from "@/src/common/components/shadcn/toggle.tsx";
	...
	return (
		<ToggleGroupPrimitive.Item
			...
			className={cn(
				...
				"group-data-[orientation=horizontal]/toggle-group:data-[spacing=0]:data-[variant=outline]:first:border-l-md",
				"group-data-[orientation=horizontal]/toggle-group:data-[spacing=0]:data-[variant=outline]:border-l",
