...
/**
 * TODO: reidenzon - Do some things...
 *  Expose badgeIndicator property, to better render.
 *  Expose onOpenChange event, for optimization.
 */
			...
			<>
				...
				<Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen} modal={modalPopover}>
									...
									>
											...
											.map((value) => {
												...
												return (
													...
													>
														...
														>
															<XCircle className={cn("size-3", responsiveSettings.compactMode && "size-2.5")} />
														</div>
													</Badge>
												);
											})
										...
										{selectedValues.length > responsiveSettings.maxCount && (
											...
											>
												...
												<XCircle
													className={cn("ml-2 size-4 cursor-pointer", responsiveSettings.compactMode && "ml-1 size-3")}
													onClick={(event) => {
														event.stopPropagation();
														clearExtraOptions();
													}}
					...
					{animation > 0 && selectedValues.length > 0 && (
						<WandSparkles
							className={cn("text-foreground bg-background my-2 size-3 cursor-pointer", isAnimating ? "" : "text-muted-foreground")}
