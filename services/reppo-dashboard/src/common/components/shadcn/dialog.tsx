...
import * as React from "react"; // https://ui.shadcn.com/docs/components/dialog
		...
		<DialogPortal data-slot="dialog-portal">
			...
			<DialogPrimitive.Content
				...
				className={cn(
					...
					// custom — max height + scroll so embedded content (e.g. Stripe) doesn't clip
...
function DialogTitle({ className, ...props }: React.ComponentProps<typeof DialogPrimitive.Title>) {
	return <DialogPrimitive.Title data-slot="dialog-title" className={cn("text-lg leading-none font-normal", className)} {...props} />;
}
