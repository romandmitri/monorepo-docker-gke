...
variable "member_artifacts" {
  description = "List of users that need to pull from Artifact Registry."
  type        = list(string)
}
...
variable "member_storage" {
  description = "Service accounts able to write to storage."
  type        = list(string)
}
...
variable "service_account" {
  description = "Terraform service account to grant on project."
  type        = string
}
